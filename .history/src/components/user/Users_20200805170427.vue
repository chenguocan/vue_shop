<template>
    <div>
        ...
        <!-- 修改用户信息 -->
        <el-dialog title="提示" :visible.sync="modifyDialogVisible" :model="modifyUserForm" width="50%">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="submitModifyForm(modifyUserForm.id)">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
