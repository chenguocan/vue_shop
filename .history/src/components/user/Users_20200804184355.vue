<template>
    <div>
        ...
        <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="30%">
            <el-form :model="addUserForm" :rules="rules" label-width="100px" class="demo-ruleForm">
                <el-form-item label="用户名" prop="username">
                    <el-input v-model="addUserForm.username" type="text"></el-input>
                </el-form-item>
                <el-form-item label="密码" v-model="addUserForm.password">
                    <el-input></el-input>
                </el-form-item>
                <el-form-item label="邮箱" v-model="addUserForm.email">
                    <el-input></el-input>
                </el-form-item>
                <el-form-item label="手机" v-model="addUserForm.mobile">
                    <el-input></el-input>
                </el-form-item>
            </el-form>
            <!-- 底部区域 -->
