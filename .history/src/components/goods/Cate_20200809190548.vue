        ...
        <el-dialog title="添加分类" :visible.sync="addCateDialogVisible" width="50%">
            <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px"
                ...
                <el-form-item label="父级分类">
                    <!-- 级联选择器 -->
                    <!-- <el-cascader v-model="selectedKeys" props.expandTrigger=hover :props.checkStrictly=true
                        :options="parentCateList" :props="cascaderProps" @change="parentCateChanged">
                    </el-cascader> -->
                    <el-cascader v-model="selectedKeys" :options="parentCateList" :props="{ expandTrigger: 'hover' }"
