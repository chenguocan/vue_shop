<template>
    <div>
            ...
            <el-table :data="roleList" border stripe>
                ...
                <el-table-column label="操作" width="300">
                    <template v-slot="scope">
                        <el-button size="mini" type="primary" icon="el-icon-edit" @click="editDialogVisible=true">编辑
                        </el-button>
        ...
        <el-dialog title="编辑" :visible.sync="editDialogVisible" width="30%">
            <span slot="footer" class="dialog-footer">
                <el-form :model="editroleList" :rules="rules" label-width="80px" ref="addroleListRef">
                    <el-form-item label="角色名称" prop="id">
                        <el-input v-model="editList.id"></el-input>
                    </el-form-item>
                    <el-form-item label="角色名称" prop="roleName">
