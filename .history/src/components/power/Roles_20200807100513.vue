                ...
                <el-table-column type="expand">
                    <template v-slot="scope">
                        <el-row :class="['bdbottom',i1===0?'bdtop':'','vcenter']"
                            ...
                            <!-- 渲染一级权限 -->
                            <el-col :span="5">
                                <el-tag closable @close="removeRightsById(item1.id,scope.row)>{{item1.authName}}</el-tag>
                            ...
                            <el-col :span="19">
                                ...
                                <el-row :class="[i2===0?'':'bdtop','vcenter']" v-for="(item2,i2) in item1.children"
                                    :key="item2.id">
                                    <el-col :span="6">
                                        <el-tag type="success" closable @close="removeRightsById(item2.id,scope.row)>{{item2.authName}}</el-tag>
                                        <i class=" el-icon-caret-right"></i>
                                    </el-col>
                                    <el-col :span="18">
